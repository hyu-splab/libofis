...
static struct _dpu_description_t vD_description = {
    ...
    .hw.memories.ci_pc_lsb_nr_phys_bits = 6,
...
static struct _dpu_description_t vD_fun_v1_4_description = {
    .hw.signature.chip_id = vD_fun_v1_4,
    .hw.topology.nr_of_control_interfaces = 1,
    .hw.topology.ci_mask = 255,
    .hw.topology.nr_of_dpus_per_control_interface = 1,
    .hw.timings.carousel.cmd_duration = 2,
    ...
    .hw.timings.clock_division = 2,
    .hw.memories.mram_size = 67108864,
    .hw.memories.wram_size = 15872,
    .hw.memories.iram_size = 3968,
    .hw.memories.ci_pc_lsb_nr_phys_bits = 6,
...
const dpu_description_t dpu_chip_descriptions[NEXT_DPU_CHIP_IDX] = {
    ...
    [9] = &vD_fun_v1_4_description,
    [10] = &vD_asic1_v1_4_description,
    [11] = &vD_asic8_v1_4_description,
    [12] = &vD_fpga1_v1_4_description,
    [13] = &vD_fpga8_v1_4_description,
    [14] = &vD_asic4_v1_4_description,
    [15] = &vD_fpga4_v1_4_description,
};
