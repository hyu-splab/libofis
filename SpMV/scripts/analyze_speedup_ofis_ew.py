...
process_files("ofis256-rank", "ew256", './figures/speedup-ofis256-rank-ew256.txt')

process_files("ofis512-rank", "ew256", './figures/speedup-ofis512-rank-ew256.txt')

process_files("ofis512-ig", "ew256", './figures/speedup-ofis512-ig-ew256.txt')
