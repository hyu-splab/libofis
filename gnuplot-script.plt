...
# << Figure 14 >>
reset
# set title "End-to-End Time Breakdown (1024 DPUs)" offset 0,0
set size 1.0, 0.5
...
# set xtics rotate by 20 offset -1.1,-0.7
set xtics nomirror font ",16"
set ytics 10
set grid y
set key inside left top horizontal samplen 2 spacing 1.2 font ",18"
...
set terminal postscript eps enhanced color 20
set output "graphs/14_e2e-breakdown_400.eps"

plot newhistogram "BA-400" offset 0,-0.6, 'SpMV/figures/combined-400-e2e.txt' u 2:xtic(1) lc rgb "#8DD3C7" t "Computation", \
'' u 3 lc rgb "#aa8ee3" t "Partitioning", \
newhistogram "BA-600" offset 0,-0.6, 'SpMV/figures/combined-600-e2e.txt' u 2:xtic(1) lc rgb "#8DD3C7" notitle, \
'' u 3 lc rgb "#aa8ee3" notitle, \
newhistogram "BA-800" offset 0,-0.6, 'SpMV/figures/combined-800-e2e.txt' u 2:xtic(1) lc rgb "#8DD3C7" notitle, \
'' u 3 lc rgb "#aa8ee3" notitle
...
set ytics 10
set y2tics 50
set y2label offset -.5,0
set y2label "Time (sec)" offset -.5,0
set grid y
set key inside left top horizontal samplen 2 spacing 1.2 font ",18"
...
set terminal postscript eps enhanced color 20
set output "graphs/14_e2e-breakdown_all.eps"

plot newhistogram "SpMV(BA-600)" offset 0,-0.6, 'SpMV/figures/combined-600-e2e.txt' u 2:xtic(1) axes x1y1 lc rgb "#8DD3C7" t "Computation", \
'' u 3 lc rgb "#aa8ee3" t "Partitioning", \
newhistogram "Regex" offset 0,-0.6, 'Regex/figures/combined.txt' u 2:xtic(1) axes x1y2 lc rgb "#8DD3C7" notitle