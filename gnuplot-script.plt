...
set grid y
set key at graph 0.99, 0.99 right top vertical samplen 1 spacing 1.2 font ",18"
set style data histograms
...
set ytics 50
set grid y
set key inside left top horizontal samplen 1 spacing 1.2 font ",18"
set style data histograms
set style histogram rowstacked gap 10
set boxwidth 0.85
set style fill solid border -1
set terminal postscript eps enhanced color 20
set output "graphs/14_2_e2e-breakdown_regex.eps"
