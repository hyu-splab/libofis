...
if 'ofis_dpu' in input_file:
    output_file = f'{output_dir}/ofis-dpu.txt'
elif 'ofis_ig' in input_file:
    output_file = f'{output_dir}/ofis-ig.txt'
elif 'ofis_rank' in input_file:
